...
public class StaffController {
    ...
    public ResponseEntity<APIResponse<?>> createCustomerInformation(@PathVariable int id, @RequestParam MultipartFile image, @RequestPart StaffInformationRequest staffInformationRequest){
    ...
    public ResponseEntity<APIResponse<?>> updateCustomerInformation(@PathVariable int id,@RequestParam MultipartFile image ,@RequestPart StaffInformationRequest staffInformationRequest){
        StaffInformationResponse result =
